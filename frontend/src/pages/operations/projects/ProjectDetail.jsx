  ...
  const fetchProject = async () => {
    try {
      ...
      const response = await fetch(
        `${API_URL}/api/operations/projects/${project_id}`,
        {
        ...
        <div className="px-8 py-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="text-sm text-gray-500">
              Operations → Projects → {project.project_id}
            </span>
          </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-4 mt-1">
                  <span
                    className={`px-2 py-1 rounded-full text-xs font-semibold capitalize ${getStatusBadge(project.status)}`}
                  >
                    {project.status}
                  </span>
                  <span className="text-sm text-gray-500">
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p
                      className={`font-medium capitalize ${project.sla_status === "on_track" ? "text-green-600" : project.sla_status === "at_risk" ? "text-yellow-600" : "text-red-600"}`}
                    >
                ...
                {project.milestones.map((milestone, i) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      >
                        <CheckCircle
                          className={`h-4 w-4 ${milestone.status === "completed" ? "text-green-600" : "text-gray-400"}`}
                        />
                      </div>
                      <div>
                        <p className="font-medium text-gray-900">
                ...
                <tbody className="divide-y divide-gray-100">
                  {project.inventory.map((inv) => (
                    <tr key={inv.allocation_id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-center text-gray-700">
                        {inv.quantity_consumed}
                      </td>
                      <td className="px-6 py-4 text-center">
                        <span
                          className={`px-2 py-1 rounded text-xs font-medium capitalize ${
                            inv.allocation_status === "fully_consumed"
                              ? "bg-green-100 text-green-700"
                              : "bg-blue-100 text-blue-700"
                          }`}
                        >
                          {inv.allocation_status?.replace("_", " ")}
                        </span>
                      </td>
                    </tr>
                  ))}
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-400 mt-2">
                            Type: {issue.issue_type} • Raised: {issue.raised_at}
                          </p>
                        </div>
                      </div>
                      <span
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <p className="text-2xl font-bold text-[#033F99] mt-1">
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <p className="text-2xl font-bold text-yellow-600 mt-1">
                  ₹{(project.budget?.committed || 0).toLocaleString()}
                </p>
              </div>
              <div className="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <p className="text-2xl font-bold text-green-600 mt-1">
                  ...
                  {(
                    ...
                    (project.budget?.total || 0) - (project.budget?.spent || 0)
                  ).toLocaleString()}
                </p>
              </div>
            </div>
              ...
              {project.budget?.breakdown?.length > 0 ? (
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {project.budget.breakdown.map((item, i) => {
                      const variance =
                        (item.actual || 0) - (item.budgeted || 0);
                      const utilization = item.budgeted
                        ? ((item.actual || 0) / item.budgeted) * 100
                        : 0;
                      return (
                        <tr key={i} className="hover:bg-gray-50">
                          ...
                          <td
                            className={`px-6 py-4 text-right font-medium ${variance > 0 ? "text-red-600" : "text-green-600"}`}
                          >
                            {variance > 0 ? "+" : ""}₹
                ...
                <div className="px-6 py-12 text-center text-gray-500">
                  ...
                  <p className="text-sm mt-2">
                    Budget data will appear here once costs are tracked
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            ...
            {project.changelog?.length > 0 ? (
              ...
              <div className="px-6 py-12 text-center text-gray-500">
                ...
                <p className="text-sm mt-2">
                  Project modifications will appear here
                </p>
              </div>
            )}
          </div>
