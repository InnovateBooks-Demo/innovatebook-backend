  ...
  const handleDownloadPDF = async () => {
    try {
      ...
      const companyDetails = {
        name: "Innovate Books",
        address:
          "Plot No. 123, Tech Park, Bangalore - 560001, Karnataka, India",
              ...
              <div className="space-y-3">
                <div className="flex justify-between py-2">
                  ...
                  <span className="font-semibold text-gray-900">
                    {formatCurrency(bill.base_amount || 0)}
                  </span>
                </div>
                ...
                {(() => {
                  ...
                  return (
                    <div className="bg-[rgba(3,63,153,0.08)] rounded-lg p-3 space-y-2">
                      <div className="text-xs font-semibold text-blue-900 mb-2">
                        {gstBreakdown.type} (Inter-state:{" "}
                        {gstBreakdown.isInterState ? "Yes" : "No"})
                      </div>
                      ...
                      <div className="flex justify-between py-2 border-t border-[rgba(3,63,153,0.25)] mt-2">
                ...
                {bill.tds_percent > 0 && (
                  <div className="bg-orange-50 rounded-lg p-3">
                    ...
                    {(() => {
                      const tdsSection = getTDSSection(
                ...
                <div className="flex justify-between py-3 border-t-2 border-red-600">
                  ...
                  <span className="text-xl font-bold text-red-600">
                    {formatCurrency(bill.net_payable || 0)}
                  </span>
                </div>
                <div className="flex justify-between py-2 bg-[rgba(3,63,153,0.08)] rounded-lg px-3">
