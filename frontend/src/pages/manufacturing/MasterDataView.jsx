...
const MasterDataView = () => {
  ...
  const tabs = [
    {
      ...
      label: "Customers",
      icon: Building2,
      endpoint: "/api/manufacturing/masters/customers",
      dataKey: "customers",
    },
    {
      id: "product-families",
      ...
      icon: Package,
      endpoint: "/api/manufacturing/masters/product-families",
      dataKey: "product_families",
    },
    {
      id: "skus",
      label: "SKUs",
      icon: Package,
      endpoint: "/api/manufacturing/masters/skus",
      dataKey: "skus",
    },
    {
      id: "plants",
      label: "Plants",
      icon: Factory,
      endpoint: "/api/manufacturing/masters/plants",
      dataKey: "plants",
    },
    {
      id: "raw-materials",
      label: "Raw Materials",
      icon: Package,
      endpoint: "/api/manufacturing/masters/raw-materials",
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axios.get(
        `${BACKEND_URL}${activeTabConfig.endpoint}`,
      );
  ...
  const renderCustomerRow = (customer) => (
    <tr
      key={customer.id}
      className="hover:bg-[rgba(3,63,153,0.08)] transition-colors"
    >
      ...
      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
        ₹{(customer.credit_limit / 10000000).toFixed(1)}Cr
      </td>
  ...
  const renderSKURow = (sku) => (
    ...
    >
      ...
      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
        ₹{(sku.standard_price || 0).toLocaleString()}
      </td>
      <td className="px-6 py-4 whitespace-nowrap">
        <span
          className={`px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${
  ...
  const renderRawMaterialRow = (material) => (
    ...
    >
      ...
      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
        ₹{(material.standard_price || 0).toLocaleString()}
      </td>
    </tr>
  );
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-6">
      ...
      <div className="mb-8">
        <button
          ...
          className="flex items-center gap-2 text-[#033F99] hover:text-blue-700 font-semibold mb-4"
        >
        ...
        <p className="text-gray-600">
          View and manage manufacturing master data
        </p>
      </div>
