            ...
            <div className="flex gap-3 mb-6 flex-wrap">
              {productionOrders.map((o, i) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-medium transition-all ${selectedOrder === i ? "bg-[#033F99] text-white" : "bg-white text-slate-700 border border-slate-300 hover:border-[#033F99]"}`}
                >
                  {o.id}
                </button>
              ))}
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200">
              ...
              <div className="mb-6">
                ...
                <div className="h-4 bg-slate-200 rounded-full overflow-hidden">
                  <div
                    className="h-full bg-gradient-to-r from-[#033F99] to-[#033F99] rounded-full"
