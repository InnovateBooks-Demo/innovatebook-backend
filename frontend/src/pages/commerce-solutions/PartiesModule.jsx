...
const PartiesModule = () => {
  const whyPartiesFirst = [
    {
      ...
      description:
        "Every transaction requires a verified counterparty. Without knowing WHO you can transact with, nothing else matters.",
      icon: Users,
    },
    {
      reason: "Risk Prevention at Source",
      description:
        "Bad customer? Risky vendor? Block at the party level before any deal, quote, or PO is created.",
      icon: Shield,
    },
    {
      reason: "Credit & Exposure Control",
      description:
        "Set credit limits, monitor exposure, prevent overcommitment - all at the counterparty level.",
      icon: DollarSign,
    },
    {
      reason: "Progressive Intelligence",
      description:
        "Party profiles evolve with history. Good behavior = increased limits. Poor behavior = tighter controls.",
      icon: Activity,
    },
  ];
  ...
  const realWorldScenarios = [
    {
      ...
      problem:
        "Sales team creates $150K deal with customer already at $450K exposure (limit: $500K)",
      without: {
        what: "Deal proceeds, contract signed",
        then: "Customer delays payment on existing $450K",
        result:
          "Total exposure now $600K. $100K over limit. Customer leverage increases. Collection becomes difficult.",
      ...
      with: {
        ...
        result:
          "CFO reviews, requests advance payment or parent guarantee. Deal restructured safely.",
    ...
    },
    {
      ...
      problem:
        "Procurement wants to engage vendor for $40K/month cloud services",
      without: {
        what: "PO raised, contract signed, services start",
        then: "3 months in, audit reveals vendor lacks SOC2 compliance",
        result:
          "Regulatory violation. Must terminate urgently. 3-month scramble for replacement. Project delays.",
      ...
      with: {
        ...
        result:
          "Vendor asked to provide SOC2 before contract. Alternative vendors identified. No commitment until compliant.",
    ...
    },
    {
      ...
      without: {
        ...
        result:
          "Commission not factored in pricing. Net revenue only $160K. Margin calculation was wrong. Deal unprofitable.",
      ...
      with: {
        ...
        result:
          "Pricing adjusted to maintain margin. Partner commission factored upfront. No surprises.",
  ...
  const partyLifecycle = [
    {
      stage: "Onboarding",
      desc: "Initial verification & risk assessment",
      icon: Users,
    },
    {
      stage: "Initial Limits",
      desc: "Conservative credit/spend limits set",
      icon: Shield,
    },
    {
      stage: "First Transactions",
      desc: "Performance tracking begins",
      icon: Activity,
    },
    {
      stage: "Behavior Analysis",
      desc: "Payment/delivery patterns evaluated",
      icon: BarChart3,
    },
    {
      stage: "Profile Upgrade",
      desc: "Good behavior = increased limits",
      icon: TrendingUp,
    },
    {
      stage: "Trusted Partner",
      desc: "Streamlined approvals, higher limits",
      icon: Star,
    },
  ];
  ...
  return (
    <IBCommerceHub>
      <div className="max-w-6xl">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-xl text-slate-600">
                Who You Are Allowed to Do Business With
              </p>
            </div>
          </div>
          <div className="bg-red-50 border-2 border-red-200 rounded-2xl p-4 inline-block">
            <p className="text-red-700 font-bold flex items-center gap-2">
              ...
              WHY PARTIES IS FIRST: Every commercial failure starts with the
              wrong counterparty
            </p>
          </div>
        </div>
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-slate-900 mb-6">
            Real-World Commercial Failures Prevented
          </h2>
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-slate-900 mb-6">
            Progressive Party Lifecycle
          </h2>
          <p className="text-lg text-slate-700 mb-6">
            Unlike static master data, Parties evolve based on performance. Good
            behavior = increased privileges. Poor behavior = tighter controls.
          </p>
          <div className="relative">
            {partyLifecycle.map((stage, index) => {
              ...
              return (
                <div
                  key={`item-${index}`}
                  className="flex items-start gap-6 mb-6 last:mb-0"
                >
          ...
          <div className="space-y-6">
            {subModules.map((subModule, index) => {
              ...
              return (
                <div
                  key={`item-${index}`}
                  className="bg-white rounded-3xl border-2 border-slate-200 overflow-hidden hover:border-blue-500 hover:shadow-xl transition-all"
                >
                  <div className="p-6">
                        ...
                        <div className="space-y-2 text-sm">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-slate-700">
                              {subModule.metrics.reduction}
                            </span>
                          </div>
                          <div className="flex items-center gap-2">
                            <Shield className="h-4 w-4 text-[#033F99]" />
                            <span className="text-slate-700">
                              {subModule.metrics.control}
                            </span>
                          </div>
                          <div className="flex items-center gap-2">
                            <Activity className="h-4 w-4 text-[#033F99]" />
                            <span className="text-slate-700">
                              {subModule.metrics.visibility}
                            </span>
                          </div>
                        </div>
                      </div>
        ...
        <section className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-3xl p-8 text-white text-center">
          <h2 className="text-3xl font-bold mb-4">
            Ready to Prevent Commercial Failures?
          </h2>
