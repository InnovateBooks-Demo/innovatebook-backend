...
const CommitPage = () => {
  ...
  const commitComponents = [
    ...
    },
    {
      ...
      controlPoints: [
        "Customer authority validated",
        "No unauthorized changes",
        "Binding commitment received",
      ],
    },
  ];
  ...
  const approvalMatrix = [
    ...
    },
    {
      ...
      discount: "≤25%",
      terms: "Standard",
      approvers: ["Sales Manager", "Finance"],
    },
    {
      dealSize: "$250K - $1M",
      discount: "≤30%",
      terms: "Extended OK",
      approvers: ["Sales Director", "Finance", "Legal"],
    },
    {
      dealSize: "$1M+",
      discount: "Any",
      terms: "Custom OK",
      approvers: ["VP Sales", "CFO", "Legal", "CEO (>$5M)"],
    },
  ];
  ...
  const realScenarios = [
    {
      ...
      situation:
        "Sales rep sent quote for $200K. Customer signed. Post-signature, rep realized cost estimate was wrong - actual cost $220K.",
      problem: {
        quotedPrice: "$200,000",
        actualCost: "$220,000",
        margin: "-10% (loss)",
      ...
      rootCause:
        "No costing verification before quote sent. Rep used old cost estimate.",
      withSystem: {
        controls: [
        ...
        outcome:
          "Cost discrepancy caught before quote sent. Price corrected to $250K. Won at $245K with 10% margin.",
      },
    },
    {
      ...
      situation:
        "End of quarter. Rep promised 45% discount to close large deal. Normal max is 30%. Finance discovered after booking.",
      impact: {
      ...
      withSystem: {
        ...
        outcome:
          "Discount request would have been visible. VP either approves with justification or requires negotiation. Either way, controlled.",
      },
    },
    {
      ...
      situation:
        "Standard SOW template used for custom project. Customer signed. Scope was actually much larger than template assumed.",
      problem: {
      ...
      withSystem: {
        ...
        outcome:
          "Scope mismatch identified during review. SOW revised before sending. Project properly scoped.",
      },
    },
  ];
  ...
  const commitChecklist = [
    {
      ...
      items: [
        ...
        "Delivery feasibility confirmed",
        "Pricing approved",
      ],
    },
    {
      ...
      <div className="max-w-6xl">
        ...
        <div className="bg-[rgba(3,63,153,0.08)] border-2 border-[rgba(3,63,153,0.25)] rounded-2xl p-6 mb-12">
          <p className="text-lg text-blue-900 mb-2">
            <strong>Purpose:</strong> The moment of truth. Once committed,
            you're bound. Ensure every commitment is profitable, deliverable,
            and approved.
          </p>
          ...
          <div className="space-y-12">
            ...
            <section className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-3xl p-8 text-white">
              ...
              <p className="text-xl leading-relaxed mb-6">
                A quote is a promise. A contract is binding. Before any
                commitment leaves your company, ensure it's accurate,
                profitable, and approved by the right people.
              </p>
                  ...
                  >
                    ...
                    <ul className="space-y-3">
                      {category.items.map((item, i) => (
                        ...
                        >
                          <CheckSquare className="h-5 w-5 text-[#033F99]" />
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {component.elements.map((el, i) => (
                        ...
                        >
                          <CheckCircle className="h-4 w-4 text-[#033F99]" />
                          {el}
                        </li>
                      ))}
                    </ul>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {component.controlPoints.map((cp, i) => (
                        <li
                          key={`item-${i}`}
                          className="flex items-center gap-2 text-slate-700 bg-[rgba(3,63,153,0.08)] p-2 rounded-lg"
                        >
          ...
          <div className="space-y-8">
            <div className="bg-[rgba(3,63,153,0.08)] p-6 rounded-2xl border-2 border-[rgba(3,63,153,0.25)]">
              ...
              <p className="text-blue-800">
                Who needs to approve what, based on deal characteristics
              </p>
            </div>
            ...
            <div className="bg-yellow-50 p-6 rounded-2xl border-2 border-yellow-200">
              ...
              <p className="text-yellow-800 mb-4">
                When deals require exceptions to standard matrix:
              </p>
              <ul className="space-y-2">
                {[
                  ...
                  {scenario.impact && (
                    <div className="bg-red-50 p-6 rounded-2xl border-2 border-red-200">
                      ...
                      <div className="space-y-3">
                        {Object.entries(scenario.impact).map(
                          ([key, value], i) => (
                            <div
                              key={`item-${i}`}
                              className="flex justify-between"
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-600 to-blue-800 rounded-3xl p-8 text-white text-center">
          ...
          <p className="text-xl mb-6 opacity-90">
            Every quote accurate. Every deal approved. Every commitment
            profitable.
          </p>
