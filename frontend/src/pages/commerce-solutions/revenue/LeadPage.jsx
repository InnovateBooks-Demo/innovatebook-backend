    ...
    bant: {
      ...
      criteria: [
        ...
        },
        {
          letter: "A",
          name: "Authority",
          question: "Are we talking to decision maker?",
          score: "25 points",
        },
        {
          letter: "N",
          name: "Need",
          question: "Is there a clear business need?",
          score: "25 points",
        },
        {
          letter: "T",
          name: "Timeline",
          question: "When do they need to decide?",
          score: "25 points",
        },
      ],
      scoring: {
  ...
  const realScenarios = [
    {
      ...
      situation:
        'Marketing generated 500 leads/month. Sales complained about "low quality." Actually, leads were going cold due to slow follow-up.',
      metrics: {
        leadsPerMonth: 500,
      ...
      problem:
        "Research shows lead conversion drops 80% after first hour. 4.5 day response = dead leads.",
      withSystem: {
        changes: [
    ...
    },
    {
      ...
      situation:
        "Reps focused on leads with biggest titles. Missed that many enterprise deals start with middle managers who have budget authority.",
      problem: {
      ...
      withSystem: {
        ...
        outcome:
          "Discovered 40% of $500K+ deals started with Director-level contacts. Adjusted scoring. Conversion improved 45%.",
      },
    },
  ];
      ...
      <div className="max-w-6xl">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-2xl text-slate-600">
              Capture, Qualify & Convert Opportunities
            </p>
          </div>
        </div>
        ...
        <div className="bg-green-50 border-2 border-green-200 rounded-2xl p-6 mb-12">
          <p className="text-lg text-green-900 mb-2">
            <strong>Purpose:</strong> Ensure no potential revenue slips through
            the cracks. Systematic lead handling increases conversion by 3-5x.
          </p>
          ...
          <div className="space-y-12">
                        ...
                        <td className="p-4">
                          <span
                            className={`px-3 py-1 rounded-full font-bold ${
                              parseInt(source.conversionRate) > 25
                                ? "bg-green-100 text-green-700"
                                : parseInt(source.conversionRate) > 15
            ...
            <section className="bg-gradient-to-r from-green-600 to-green-800 rounded-3xl p-8 text-white">
              <h2 className="text-3xl font-bold mb-4">
                Speed to Lead = Speed to Revenue
              </h2>
              <p className="text-xl leading-relaxed mb-6">
                Research shows contacting a lead within 5 minutes makes you 9x
                more likely to convert. After 30 minutes, your odds drop by 21x.
              </p>
        ...
        {activeTab === "qualification" && (
          <div className="space-y-8">
            <div className="bg-white rounded-3xl border-2 border-slate-200 p-8">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">
                {leadQualificationFramework.bant.name}
              </h2>
              <div className="space-y-4">
                {leadQualificationFramework.bant.criteria.map(
                  (criterion, i) => (
                    <div
                      key={`item-${i}`}
              ...
              <div className="mt-8">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {Object.entries(leadQualificationFramework.bant.scoring).map(
                    ([range, action], i) => (
                      <div
                        key={`item-${i}`}
                    ...
                    <div className="bg-green-50 p-6 rounded-2xl border-2 border-green-200">
                      ...
                      {scenario.withSystem.newMetrics && (
                        <div className="grid md:grid-cols-3 gap-4 mb-4">
                          {Object.entries(scenario.withSystem.newMetrics).map(
                            ([key, value], i) => (
                              <div
                                key={`item-${i}`}
        ...
        <div className="mt-16 bg-gradient-to-r from-green-600 to-green-800 rounded-3xl p-8 text-white text-center">
          ...
          <p className="text-xl mb-6 opacity-90">
            Turn marketing investment into pipeline with systematic lead
            management
          </p>
