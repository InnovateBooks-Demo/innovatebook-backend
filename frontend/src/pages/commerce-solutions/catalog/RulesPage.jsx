  ...
  const ruleCategories = [
    {
      ...
      rules: [
        {
          rule: "Maximum Discount",
          example: "No discount > 25% without VP approval",
          enforcement: "Quote blocked if exceeded",
        },
        {
          rule: "Minimum Price",
          example: "Floor price = Cost + 20% minimum margin",
          enforcement: "Cannot quote below floor",
        },
        {
          rule: "Bundle Pricing",
          example: "When items bundled, apply 10% bundle discount",
          enforcement: "Auto-calculated",
        },
        {
          rule: "Promotional Limits",
          example: "Promo codes limited to 15% off, $500 max",
          enforcement: "Code rejected if exceeded",
        },
      ],
    },
    {
      ...
      rules: [
        {
          rule: "Embargoed Countries",
          example: "Cannot sell to sanctioned nations",
          enforcement: "Deal blocked at creation",
        },
        {
          rule: "Regional Licensing",
          example: "Product X only available in US/EU",
          enforcement: "Item hidden for other regions",
        },
        {
          rule: "Local Entity Required",
          example: "Enterprise deals need local subsidiary",
          enforcement: "Partner assignment required",
        },
        {
          rule: "Data Residency",
          example: "Customer data must stay in-region",
          enforcement: "Hosting region locked",
        },
      ],
    },
    {
      ...
      rules: [
        {
          rule: "Contract Terms",
          example: "Indemnification clause required for deals > $100K",
          enforcement: "Legal review triggered",
        },
        {
          rule: "Industry Certifications",
          example: "Healthcare deals require HIPAA compliance",
          enforcement: "Compliance checklist enforced",
        },
        {
          rule: "Export Controls",
          example: "Encryption products need export license",
          enforcement: "Export approval workflow",
        },
        {
          rule: "Privacy Requirements",
          example: "GDPR DPA required for EU customers",
          enforcement: "Document attachment required",
        },
      ],
    },
    {
      ...
      rules: [
        {
          rule: "Deal Size Thresholds",
          example: ">$500K needs CFO approval",
          enforcement: "Approval workflow auto-triggered",
        },
        {
          rule: "Payment Terms",
          example: "Net 60+ needs Finance Director",
          enforcement: "Cannot proceed without approval",
        },
        {
          rule: "Custom Pricing",
          example: "Any off-list pricing needs Sales VP",
          enforcement: "Quote held pending approval",
        },
        {
          rule: "Non-Standard Terms",
          example: "SLA modifications need Legal review",
          enforcement: "Legal task created",
        },
      ],
    },
  ];
  ...
  const realScenarios = [
    {
      ...
      situation:
        "Sales rep in EMEA identified a $2M opportunity with a company headquartered in a sanctioned country. Rep was unaware of export restrictions.",
      withoutRules: {
        ...
        result:
          "Deal cancelled after 4 months of work. Customer relationship damaged. Potential regulatory scrutiny.",
    ...
    },
    {
      ...
      situation:
        'Sales rep promised 60% discount to close a "strategic" deal. Normal max discount is 25%.',
      withoutRules: {
        ...
        result:
          "Deal closes at 10% margin instead of 45%. Similar discounts requested by other customers. Price integrity eroded.",
      ...
      withRules: {
        ...
        review:
          "VP sees this would set bad precedent, negotiates to 35% discount",
    ...
    },
    {
      ...
      situation:
        "Account exec sells to hospital system without realizing healthcare compliance requirements.",
      withoutRules: {
        what: "Standard contract signed, deployment begins",
        discovery:
          "Customer legal team asks for BAA (Business Associate Agreement) post-signature",
        result:
          "Deployment halted for 3 months while compliance achieved. Customer trust damaged.",
      ...
      withRules: {
        ...
        action:
          "Compliance checklist auto-attached: BAA required, HIPAA controls needed",
        result:
          "Sales involves compliance team early. Proper contracts from start.",
  ...
  const ruleTypes = [
    {
      ...
      examples: [
        "Embargoed country = deal blocked",
        "Below minimum margin = quote blocked",
        "Missing compliance docs = contract blocked",
      ],
      color: "red",
    },
    {
    ...
    },
    {
      ...
      examples: [
        "Large deal needs CFO",
        "Custom terms need Legal",
        "Extended payment needs Finance",
      ],
      color: "blue",
    },
    {
      ...
      examples: [
        "Healthcare deal → add BAA checklist",
        "International deal → add export review",
        "Enterprise → assign solutions architect",
      ],
      color: "green",
    },
  ];
  ...
  return (
    <IBCommerceHub>
      <div className="max-w-6xl">
        {/* Header */}
        <Link
          to="/solutions/commerce/catalog"
          className="flex items-center gap-2 text-purple-600 hover:text-purple-700 mb-4 font-semibold"
        >
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-2xl text-slate-600">
              Commercial Guardrails & Policy Automation
            </p>
          </div>
        </div>
        ...
        <div className="bg-red-50 border-2 border-red-200 rounded-2xl p-6 mb-12">
          <p className="text-lg text-red-900 mb-2">
            <strong>Purpose:</strong> Encode your commercial policies into the
            system. Rules prevent bad deals before they happen.
          </p>
          ...
          <div className="space-y-12">
                ...
                <div className="bg-green-50 p-6 rounded-2xl border-2 border-green-200">
                  ...
                  <ul className="space-y-3 text-slate-700">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-green-600 font-bold">✓</span>
                      <span>
                        Compliance requirements triggered at deal creation
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-600 font-bold">✓</span>
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-green-600 font-bold">✓</span>
                      <span>
                        Consistent policy enforcement across all deals
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-600 font-bold">✓</span>
                      <span>
                        Auto-approvals for standard deals, escalation for
                        exceptions
                      </span>
                    </li>
                  </ul>
                    ...
                    className={`p-6 rounded-2xl border-2 ${
                      type.color === "red"
                        ...
                        : type.color === "yellow"
                          ...
                          : type.color === "blue"
                            ? "bg-[rgba(3,63,153,0.08)] border-[rgba(3,63,153,0.25)]"
            ...
            <section className="bg-gradient-to-r from-red-600 to-red-800 rounded-3xl p-8 text-white">
              <h2 className="text-3xl font-bold mb-4">
                Rules = Encoded Wisdom
              </h2>
              <p className="text-xl leading-relaxed">
                Every bad deal your company has ever done taught you something.
                Rules encode that learning so it never happens again. Your best
                practices become system constraints.
              </p>
            </section>
          </div>
        )}
                      ...
                      <div className="space-y-3 text-sm text-slate-700">
                        ...
                        <div className="pt-3 border-t border-red-200">
                          <p className="font-bold text-red-800">
                            💸 Cost: {scenario.withoutRules.cost}
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="space-y-3 text-sm text-slate-700">
                        ...
                        <div className="pt-3 border-t border-green-200">
                          <p className="font-bold text-green-800">
                            💰 Saved: {scenario.withRules.saved}
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <div className="space-y-8">
            <div className="bg-gradient-to-r from-red-600 to-red-800 p-8 rounded-3xl text-white">
              ...
              <p className="text-xl opacity-90">
                A phased approach to encoding your commercial policies
              </p>
            </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-red-600 to-red-800 rounded-3xl p-8 text-white text-center">
          <h2 className="text-3xl font-bold mb-4">
            Encode Your Commercial Wisdom
          </h2>
          <p className="text-xl mb-6 opacity-90">
            Turn lessons learned into automated guardrails. Never repeat past
            mistakes.
          </p>
