  ...
  const vendorManagementFeatures = [
    {
      ...
      description:
        "Intelligent spend controls that adapt based on vendor performance, compliance status, and business criticality.",
      howItWorks: [
      ...
      prevention:
        "Prevents over-reliance on unproven vendors and under-utilization of top performers",
    },
    {
      feature: "Compliance & Risk Monitoring",
      description:
        "Real-time tracking of vendor certifications, insurance, and regulatory compliance.",
      howItWorks: [
      ...
      prevention:
        "Prevents contracts with non-compliant vendors that could create legal/regulatory exposure",
    },
    {
      feature: "Vendor Risk Scoring (0-100)",
      description:
        "Comprehensive risk assessment combining financial health, operational performance, and compliance.",
      factors: [
        {
          factor: "Delivery Performance",
          weight: "30%",
          calculation: "On-time %, quality scores, defect rates",
        },
        {
          factor: "Financial Stability",
          weight: "25%",
          calculation: "Credit rating, payment history to their suppliers",
        },
        {
          factor: "Compliance Status",
          weight: "20%",
          calculation: "Certifications, insurance, regulatory standing",
        },
        {
          factor: "Business Continuity",
          weight: "15%",
          calculation: "Backup capacity, geographic diversification",
        },
        {
          factor: "Relationship Health",
          weight: "10%",
          calculation: "Communication, responsiveness, flexibility",
        },
      ],
      example: {
    ...
    },
    {
      ...
      description:
        "Track and control how much business goes to any single vendor to prevent dangerous dependencies.",
      howItWorks: [
      ...
      prevention:
        "Prevents supply chain disruption from vendor failure or pricing leverage loss",
    },
    {
      feature: "Payment Terms Optimization",
      description:
        "Strategic payment terms based on vendor importance, cash flow needs, and relationship value.",
      termTiers: [
        {
          tier: "Strategic Partners",
          terms: "Net 60-90",
          discount: "2% early payment option",
          benefit: "Maximum flexibility",
        },
        {
          tier: "Preferred Vendors",
          terms: "Net 45",
          discount: "1.5% for Net 15",
          benefit: "Good terms, some flexibility",
        },
        {
          tier: "Standard Vendors",
          terms: "Net 30",
          discount: "1% for Net 10",
          benefit: "Industry standard",
        },
        {
          tier: "New/Trial Vendors",
          terms: "Net 15 or Prepay",
          discount: "None",
      ...
      prevention:
        "Prevents suboptimal cash management and missed discount opportunities",
    },
  ];
  ...
  const realWorldScenarios = [
    {
      ...
      situation:
        "Long-standing vendor of 5 years suddenly requests bank account change for payments.",
      withoutSystem: {
      ...
      lesson:
        "Automated controls on sensitive vendor data changes prevent sophisticated fraud schemes.",
    },
    {
      title: "The Supply Chain Resilience Story",
      company: "Electronics Manufacturer",
      situation:
        "Primary component supplier (65% of chip supply) announced factory fire, 6-month recovery.",
      withoutSystem: {
      ...
      lesson:
        "Proactive concentration monitoring enables supply chain resilience before disasters strike.",
    },
    {
      title: "The Vendor Performance Journey",
      company: "Retail Chain",
      situation:
        "New packaging supplier started with trial contract, grew into strategic partner.",
      journey: [
        {
          phase: "Trial Period",
          spend: "$25,000",
          terms: "Net 15, prepay 50%",
          performance: "95% on-time, minor quality issues",
        },
        {
          phase: "Probation",
          spend: "$75,000",
          terms: "Net 30",
          performance: "98% on-time, quality improved",
        },
        {
          phase: "Approved",
          spend: "$200,000",
          terms: "Net 30, 1% discount",
          performance: "99% on-time, zero defects",
        },
        {
          phase: "Preferred",
          spend: "$500,000",
          terms: "Net 45, 2% discount",
          performance: "Consistent excellence",
        },
        {
          phase: "Strategic",
          spend: "$1.2M",
          terms: "Net 60, joint planning",
          performance: "Innovation partner, co-development",
        },
      ],
      totalValue: "$2M annual spend over 4 years",
      costSavings: "$180,000 from improved terms + quality",
      lesson:
        "Structured vendor development creates long-term value through better terms and quality.",
    },
    {
      title: "The Compliance Crisis Averted",
      company: "Pharmaceutical Company",
      situation:
        "Key raw material supplier failed FDA audit, putting entire product line at risk.",
      withoutSystem: {
      ...
      lesson:
        "Real-time compliance monitoring protects against regulatory exposure from vendor issues.",
    },
  ];
  ...
  const bestPractices = [
    {
      ...
      description:
        "Structured assessment before any vendor can receive orders.",
    ...
    },
    {
      ...
      description:
        "Regular assessment of vendor performance against agreed metrics.",
    ...
    },
    {
      ...
      description:
        "Categorize vendors by strategic importance and manage accordingly.",
      segments: [
        {
          segment: "Strategic (Top 5%)",
          approach:
            "Executive relationships, joint planning, innovation partnerships, best terms",
        },
        {
          segment: "Preferred (Next 15%)",
          approach:
            "Regular business reviews, preferred terms, development programs",
        },
        {
          segment: "Approved (Next 30%)",
          approach: "Standard terms, periodic reviews, competitive bidding",
        },
        {
          segment: "Transactional (Bottom 50%)",
          approach:
            "Spot purchases, standard terms, minimal management overhead",
        },
      ],
    },
    {
      ...
      riskCategories: [
        {
          ...
          mitigation:
            "Credit monitoring, payment terms adjustment, insurance requirements",
        },
        {
          category: "Operational Risk",
          mitigation: "Dual sourcing, safety stock, performance bonds",
        },
        {
          category: "Compliance Risk",
          mitigation:
            "Certification tracking, audit rights, indemnification clauses",
        },
        {
          category: "Concentration Risk",
          mitigation: "Spend limits per vendor, alternative qualification",
        },
        {
          category: "Geopolitical Risk",
          mitigation: "Geographic diversification, local alternatives",
        },
      ],
      signals: [
      ...
      <div className="max-w-6xl">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-2xl text-slate-600">
                Supplier Management & Risk Control
              </p>
            </div>
          </div>
          <div className="bg-emerald-50 border-2 border-emerald-200 rounded-2xl p-6">
            <p className="text-lg text-emerald-900 mb-2">
              <strong>Purpose:</strong> Ensure vendor compliance, optimize
              spend, prevent fraud, and build supply chain resilience.
            </p>
                ...
                <div className="bg-red-50 p-6 rounded-2xl border-2 border-red-200">
                  ...
                  <ul className="space-y-3 text-slate-700">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Vendor fraud through fake invoices or bank changes
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-600 font-bold">•</span>
                      <span>
                        Supply chain disruption from single-vendor dependency
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-600 font-bold">•</span>
                      <span>
                        Compliance violations from expired certifications
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-600 font-bold">•</span>
                      <span>
                        Overpaying due to lack of performance visibility
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-600 font-bold">•</span>
                ...
                <div className="bg-green-50 p-6 rounded-2xl border-2 border-green-200">
                  ...
                  <ul className="space-y-3 text-slate-700">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-green-600 font-bold">✓</span>
                      <span>
                        Concentration alerts before dangerous dependency
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-600 font-bold">✓</span>
                ...
                {[
                  {
                    step: "1",
                    title: "Qualification",
                    desc: "Assess financial stability, compliance, and capability before first order",
                  },
                  {
                    step: "2",
                    title: "Onboarding",
                    desc: "Set up vendor master, verify bank details, establish initial terms and limits",
                  },
                  {
                    step: "3",
                    title: "Trial Period",
                    desc: "Conservative spend limits, close monitoring, frequent reviews",
                  },
                  {
                    step: "4",
                    title: "Performance Tracking",
                    desc: "Continuous monitoring of delivery, quality, and compliance metrics",
                  },
                  {
                    step: "5",
                    title: "Tier Progression",
                    desc: "Good performers earn better terms, higher limits, strategic status",
                  },
                  {
                    step: "6",
                    title: "Strategic Partnership",
                    desc: "Joint planning, innovation collaboration, executive relationships",
                  },
                ].map((item, index) => (
                  <div
                    key={`item-${index}`}
                      ...
                      <div className="space-y-3">
                        {feature.termTiers.map((tier, i) => (
                          ...
                          >
                            ...
                            <p className="text-sm text-slate-600">
                              Discount: {tier.discount} | {tier.benefit}
                            </p>
                          </div>
                        ))}
                      </div>
                  ...
                  {scenario.journey && (
                    <div>
                      <h3 className="text-2xl font-bold text-slate-900 mb-4">
                        Vendor Development Journey:
                      </h3>
                      <div className="space-y-4">
                        {scenario.journey.map((stage, i) => (
                          <div
                            key={`item-${i}`}
                            className="flex items-start gap-4 bg-gradient-to-r from-emerald-50 to-white p-6 rounded-2xl border border-emerald-200"
                          >
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-sm text-slate-600 mb-1">
                                <strong>Terms:</strong> {stage.terms}
                              </p>
          ...
          <div className="space-y-8">
            <div className="bg-gradient-to-r from-emerald-600 to-emerald-800 p-8 rounded-3xl text-white">
              ...
              <p className="text-xl opacity-90">
                Based on ISM, Gartner, and leading procurement organizations
              </p>
            </div>
                      ...
                      <div className="mt-4 bg-slate-50 p-4 rounded-xl">
                        ...
                        <ul className="space-y-1 text-sm">
                          {practice.actions.map((action, i) => (
                            <li key={`item-${i}`} className="text-slate-700">
                              • {action}
                            </li>
                          ))}
                        </ul>
        ...
        <div className="mt-16 bg-gradient-to-r from-emerald-600 to-emerald-800 rounded-3xl p-8 text-white text-center">
          ...
          <p className="text-xl mb-6 opacity-90">
            See how IB Commerce prevents fraud, ensures compliance, and builds
