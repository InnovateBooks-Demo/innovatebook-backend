  ...
  const creditManagementFeatures = [
    {
      ...
      description:
        "AI-powered credit limits that adapt based on payment behavior, transaction history, and financial health.",
      howItWorks: [
      ...
      prevention:
        "Prevents both underutilization (lost revenue) and overexposure (bad debt risk)",
    },
    {
      feature: "Real-Time Exposure Monitoring",
      description:
        "Track current exposure across all pending deals, invoices, and receivables in real-time.",
      howItWorks: [
    ...
    },
    {
      ...
      description:
        "Multi-factor risk assessment that updates automatically based on behavior.",
      factors: [
        {
          factor: "Payment History",
          weight: "35%",
          calculation: "On-time %, average delay days",
        },
        {
          factor: "Financial Health",
          weight: "25%",
          calculation: "Credit bureau score, financial statements",
        },
        {
          factor: "Business Stability",
          weight: "20%",
          calculation: "Years in business, market position",
        },
        {
          factor: "Geographic Risk",
          weight: "10%",
          calculation: "Country stability, currency risk",
        },
        {
          factor: "Industry Risk",
          weight: "10%",
          calculation: "Sector health, cyclicality",
        },
      ],
      example: {
      ...
      prevention:
        "Prevents deals with high-risk customers without proper oversight",
    },
  ];
  ...
  const realWorldScenarios = [
    {
      ...
      situation:
        "Major customer showing financial stress signs: delayed payments, news of layoffs, reduced orders.",
      withoutSystem: {
      ...
      lesson:
        "Early warning systems combined with automated actions prevent catastrophic losses.",
    },
    {
      title: "The Credit Growth Story",
      company: "Software Services Provider",
      situation:
        "New customer started with conservative $25K credit limit, proved to be exceptional.",
      journey: [
        {
          year: "Year 1",
          limit: "$25,000",
          reasoning: "New customer - conservative start",
          result: "100% on-time payments",
        },
        {
          year: "Year 2",
          limit: "$100,000",
          reasoning: "Perfect history, auto-increased",
          result: "Major project won",
        },
        {
          year: "Year 3",
          limit: "$250,000",
          reasoning: "Trusted partner status",
          result: "Enterprise deal closed",
        },
        {
          year: "Year 4",
          limit: "$500,000",
          reasoning: "Strategic account",
          result: "Multi-year contract signed",
        },
      ],
      totalRevenue: "$2.3M over 4 years",
      badDebt: "$0",
      lesson:
        "Progressive credit expansion rewards good customers and drives revenue growth.",
    },
  ];
  ...
  const bestPractices = [
    {
      ...
      description:
        "Scheduled assessment of customer creditworthiness based on recent behavior and market conditions.",
    ...
    },
    {
      ...
      description:
        "Different approval levels based on deal size, customer risk, and terms requested.",
      segments: [
        {
          segment: "Standard deals (within limit, good history)",
          approach: "Auto-approved by system",
        },
        {
          segment: "Above-limit deals (up to 20% over)",
          approach: "Manager approval required",
        },
        {
          segment: "High-risk or large deals (50%+ over limit)",
          approach: "Director/CFO approval",
        },
        {
          segment: "New customers or distressed accounts",
          approach: "Credit committee review",
        },
      ],
    },
    {
      ...
      description:
        "Continuous monitoring of customer health indicators to catch issues early.",
      signals: [
    ...
    <IBCommerceHub>
      <div className="max-w-6xl">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-2xl text-slate-600">
                Credit Management & Risk Intelligence
              </p>
            </div>
          </div>
          <div className="bg-[rgba(3,63,153,0.08)] border-2 border-[rgba(3,63,153,0.25)] rounded-2xl p-6">
            <p className="text-lg text-blue-900 mb-2">
              <strong>Purpose:</strong> Prevent bad debt, manage credit
              exposure, and enable progressive credit expansion for trustworthy
              customers.
            </p>
            <div className="grid md:grid-cols-3 gap-4 mt-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-semibold">
                  100% Credit Limit Adherence
                </span>
              </div>
              <div className="flex items-center gap-2">
                <TrendingUp className="h-5 w-5 text-green-600" />
                <span className="text-sm font-semibold">
                  10x Credit Growth Possible
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-12">
            <section>
              <h2 className="text-3xl font-bold text-slate-900 mb-6">
                Why Customer Credit Management?
              </h2>
                ...
                <div className="bg-red-50 p-6 rounded-2xl border-2 border-red-200">
                  ...
                  <ul className="space-y-3 text-slate-700">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-red-600 font-bold">•</span>
                      <span>
                        Customer overexposure not visible until too late
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-600 font-bold">•</span>
                ...
                <div className="bg-green-50 p-6 rounded-2xl border-2 border-green-200">
                  ...
                  <ul className="space-y-3 text-slate-700">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Deals blocked before contract if customer at limit
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-600 font-bold">✓</span>
                      <span>
                        Real-time exposure visible across all pending deals
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-600 font-bold">✓</span>
            ...
            <section>
              <h2 className="text-3xl font-bold text-slate-900 mb-6">
                How It Works: The Credit Journey
              </h2>
                ...
                {[
                  {
                    ...
                    desc: "Initial credit assessment, conservative limit set",
                  },
                  {
                    step: "2",
                    title: "First Transaction",
                    desc: "System monitors payment behavior, tracks against terms",
                  },
                  {
                    step: "3",
                    title: "Continuous Monitoring",
                    desc: "Risk score updates automatically",
                  },
                  {
                    step: "4",
                    title: "Performance Review",
                    desc: "Good behavior triggers limit increase review",
                  },
                  {
                    step: "5",
                    title: "Progressive Expansion",
                    desc: "Limits increase based on performance",
                  },
                  {
                    step: "6",
                    title: "Trusted Partner Status",
                    desc: "Premium terms, higher limits, streamlined approvals",
                  },
                ].map((item, index) => (
                  <div
                    key={`item-${index}`}
                        ...
                        {feature.factors.map((factor, i) => (
                          ...
                          >
                            <div className="flex items-center justify-between mb-2">
                              ...
                              <span className="text-[#033F99] font-bold">
                                {factor.weight}
                              </span>
                            </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        {scenario.journey.map((stage, i) => (
                          <div
                            key={`item-${i}`}
                            className="flex items-start gap-4 bg-gradient-to-r from-blue-50 to-white p-6 rounded-2xl border border-[rgba(3,63,153,0.25)]"
                          >
                            <div className="w-10 h-10 text-blue-700 rounded-full flex items-center justify-center text-white font-bold flex-shrink-0">
                              {i + 1}
                            </div>
          ...
          <div className="space-y-8">
            <div className="bg-gradient-to-r from-blue-600 to-blue-800 p-8 rounded-3xl text-white">
              ...
              <p className="text-xl opacity-90">
                Based on research from NACM, Gartner, and leading B2B companies
              </p>
            </div>
            ...
            {bestPractices.map((practice, index) => (
              ...
              >
                ...
                {practice.frequency && (
                  <div className="bg-[rgba(3,63,153,0.08)] p-4 rounded-xl mb-6">
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-600 to-blue-800 rounded-3xl p-8 text-white text-center">
          <h2 className="text-3xl font-bold mb-4">
            Ready to Eliminate Bad Debt?
          </h2>
          <p className="text-xl mb-6 opacity-90">
            See how IB Commerce prevents $450K+ in potential losses through
