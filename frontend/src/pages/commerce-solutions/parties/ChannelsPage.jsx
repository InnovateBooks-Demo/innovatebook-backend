  ...
  const channelManagementFeatures = [
    {
      ...
      description:
        "Track and attribute revenue across all sales channels with accurate margin analysis and performance comparison.",
      channels: [
        {
          channel: "Direct Sales",
          description: "Enterprise field sales team",
          avgDealSize: "$250K",
          margin: "45%",
          cycle: "90 days",
        },
        {
          ...
          description: "SMB telesales team",
          avgDealSize: "$25K",
          margin: "50%",
          cycle: "30 days",
        },
        {
          ...
          description: "Resellers and VARs",
          avgDealSize: "$75K",
          margin: "30%",
          cycle: "60 days",
        },
        {
          channel: "E-Commerce",
          description: "Self-service online",
          avgDealSize: "$5K",
          margin: "65%",
          cycle: "1 day",
        },
        {
          channel: "Marketplace",
          description: "AWS/Azure/GCP marketplaces",
          avgDealSize: "$45K",
          margin: "55%",
          cycle: "14 days",
        },
      ...
      prevention:
        "Prevents revenue leakage from untracked channels and enables data-driven channel investment decisions",
    },
    {
      feature: "Channel Pricing & Margin Control",
      description:
        "Manage channel-specific pricing, protect margins, and prevent unauthorized discounting.",
      pricingRules: [
        {
          rule: "List Price",
          application: "E-Commerce, marketplace",
          discount: "0%",
          margin: "65%",
        },
        {
          rule: "Volume Discount",
          application: "Direct sales, inside sales",
          discount: "10-20%",
          margin: "45-55%",
        },
        {
          rule: "Partner Discount",
          application: "Channel partners",
          discount: "25-40%",
          margin: "25-40%",
        },
        {
          rule: "Enterprise Agreement",
          application: "Strategic accounts",
          discount: "15-30%",
          margin: "35-50%",
        },
        {
          rule: "Promotional",
          application: "Time-limited campaigns",
          discount: "20-35%",
          margin: "30-45%",
        },
      ],
      ...
      prevention:
        "Prevents margin erosion from unauthorized discounts and maintains channel price integrity",
    },
    {
      feature: "Channel Conflict Management",
      description:
        "Detect, prevent, and resolve conflicts between channels pursuing the same opportunities.",
      conflictTypes: [
        {
          type: "Direct vs Partner",
          description: "Both pursuing same customer",
          resolution: "Deal registration + first contact rule",
        },
        {
          type: "Partner vs Partner",
          description: "Multiple partners on same deal",
          resolution: "Registration timestamp + customer preference",
        },
        {
          type: "Online vs Offline",
          description: "Customer comparing web vs sales price",
          resolution: "Price matching + value-add justification",
        },
        {
          type: "New vs Renewal",
          description: "Different channels for initial vs renewal",
          resolution: "Account ownership rules + handoff process",
        },
      ],
      resolutionWorkflow: [
      ...
      example: {
        ...
        resolution:
          "Partner A (first registration) leads, direct sales supports, Partner B compensated for referral",
        outcome: "Deal closed at $340K with co-sell premium",
      },
      prevention:
        "Prevents lost deals from channel in-fighting and maintains healthy channel relationships",
    },
    {
      feature: "Channel Performance Analytics",
      description:
        "Comprehensive analytics to optimize channel mix and investment allocation.",
      metrics: [
        {
          metric: "Revenue by Channel",
          insight: "Which channels drive the most revenue?",
        },
        {
          metric: "Margin by Channel",
          insight: "Which channels are most profitable?",
        },
        {
          metric: "CAC by Channel",
          insight: "Customer acquisition cost comparison",
        },
        { metric: "Sales Velocity", insight: "Time-to-close by channel" },
        { metric: "Win Rate", insight: "Competitive win rate by channel" },
        {
          metric: "Customer Lifetime Value",
          insight: "Long-term value by acquisition channel",
        },
      ],
      dashboards: [
      ...
      example: {
        ...
        analysis:
          "Self-service works for SMB but enterprise needs direct touch",
        action: "Invest in product-led growth for mid-market",
        result:
          "E-commerce revenue grew 45% next quarter while maintaining margin",
      },
      prevention:
        "Prevents suboptimal channel investment and enables data-driven go-to-market decisions",
    },
    {
      feature: "Omnichannel Customer Experience",
      description:
        "Unified customer view across all channels with seamless handoffs and consistent experience.",
      capabilities: [
        {
          capability: "Single Customer View",
          description: "All interactions across channels in one place",
          benefit: "No repetition, personalized experience",
        },
        {
          capability: "Channel Handoff",
          description: "Smooth transition between channels",
          benefit: "Customer doesn't restart conversation",
        },
        {
          capability: "Consistent Pricing",
          description: "Same pricing regardless of channel",
          benefit: "Trust and transparency",
        },
        {
          capability: "Universal Cart",
          description: "Save items across channels",
          benefit: "Convenience and flexibility",
        },
        {
          capability: "Cross-Channel Support",
          description: "Support knows all channel history",
          benefit: "Faster resolution, better satisfaction",
        },
      ],
      customerJourney: [
        {
          touchpoint: "Website",
          action: "Research products, get pricing",
          channel: "E-Commerce",
        },
        {
          touchpoint: "Chat",
          action: "Ask technical questions",
          channel: "Inside Sales",
        },
        {
          touchpoint: "Demo",
          action: "Schedule and attend demo",
          channel: "Direct Sales",
        },
        {
          touchpoint: "Quote",
          action: "Receive customized proposal",
          channel: "Direct Sales",
        },
        {
          touchpoint: "Purchase",
          action: "Buy via preferred channel",
          channel: "Any",
        },
        {
          touchpoint: "Support",
          action: "Get help when needed",
          channel: "Support",
        },
      ],
      example: {
        ...
        journey:
          "Started on website → Chat with questions → Demo with sales → Quote via partner → Purchased on marketplace",
        experience: "Seamless, all context preserved",
        result: "Deal closed in 21 days vs 45-day average",
      },
      prevention:
        "Prevents customer frustration from disconnected experiences and accelerates sales cycles",
    },
  ];
  ...
  const realWorldScenarios = [
    {
      ...
      situation:
        "Company relied 80% on direct sales, struggling with scale and CAC.",
      withoutAnalytics: {
      ...
      lesson:
        "Data-driven channel optimization can transform unit economics while accelerating growth.",
    },
    {
      title: "The MAP Enforcement Success",
      company: "Hardware Manufacturer",
      situation:
        "Online resellers undercutting prices, damaging brand and margins.",
      withoutEnforcement: {
      ...
      lesson:
        "Automated price monitoring protects brand value and channel relationships.",
    },
    {
      ...
      keyInsight:
        "Each channel unlocked new customer segment without cannibalizing existing",
    ...
    },
    {
      ...
      situation:
        "Constant conflicts between direct and partner sales destroying relationships.",
      beforeFramework: {
      ...
      lesson:
        "Clear conflict resolution rules preserve deals and relationships.",
    },
  ];
  ...
  const bestPractices = [
    {
      ...
      description:
        "Define clear channel strategy aligned with customer segments and business objectives.",
      framework: [
        {
          element: "Customer Segmentation",
          description:
            "Map customer segments to ideal channels based on deal size, complexity, support needs",
        },
        {
          element: "Channel Roles",
          description:
            "Define clear responsibilities and boundaries for each channel",
        },
        {
          element: "Economics Model",
          description: "Understand CAC, margin, and LTV by channel",
        },
        {
          element: "Coverage Rules",
          description: "Define which channel serves which accounts/territories",
        },
        {
          element: "Conflict Resolution",
          description: "Pre-define rules for common conflict scenarios",
        },
      ],
      segmentMapping: [
        {
          segment: "Enterprise ($500K+)",
          primaryChannel: "Direct Sales",
          supportChannels: "Partner for delivery",
        },
        {
          segment: "Mid-Market ($50-500K)",
          primaryChannel: "Inside Sales + Partners",
          supportChannels: "Direct for complex deals",
        },
        {
          segment: "SMB ($5-50K)",
          primaryChannel: "Partners + E-commerce",
          supportChannels: "Inside sales for upgrades",
        },
        {
          segment: "Self-Service (<$5K)",
          primaryChannel: "E-commerce + Marketplace",
          supportChannels: "Chat support",
        },
      ],
    },
    {
      ...
      elements: [
        {
          element: "Sales Playbooks",
          description:
            "Channel-specific messaging, pricing, and competitive positioning",
        },
        {
          element: "Technical Training",
          description: "Product knowledge and solution selling skills",
        },
        {
          element: "Tools Access",
          description: "CRM, CPQ, demo environments, marketing assets",
        },
        {
          element: "Support Resources",
          description: "Pre-sales support, deal desk, technical assistance",
        },
        {
          element: "Incentive Programs",
          description: "SPIFFs, contests, accelerators to drive behavior",
        },
      ],
      metrics: [
        {
          metric: "Time to First Deal",
          target: "<90 days for new reps/partners",
        },
    ...
    },
    {
      ...
      reviewCadence: [
        {
          frequency: "Weekly",
          focus: "Pipeline and forecast by channel",
          owner: "Channel Managers",
        },
        {
          frequency: "Monthly",
          focus: "Revenue, margin, win rate analysis",
          owner: "Channel Director",
        },
        {
          frequency: "Quarterly",
          focus: "Channel ROI, investment allocation",
          owner: "VP Sales/CRO",
        },
        {
          frequency: "Annual",
          focus: "Channel strategy review and planning",
          owner: "Executive Team",
        },
      ],
      actionTriggers: [
        {
          trigger: "Win rate drops >10%",
          action: "Competitive analysis, enablement review",
        },
        {
          trigger: "Margin below floor",
          action: "Pricing audit, discount approval review",
        },
        {
          trigger: "Pipeline coverage <3x",
          action: "Lead generation acceleration",
        },
        {
          trigger: "Partner churn >20%",
          action: "Partner satisfaction survey, program review",
        },
      ],
    },
    {
      ...
      description:
        "Ensure seamless data flow and user experience across channel systems.",
      integrations: [
        {
          system: "CRM",
          purpose: "Unified customer and opportunity data",
          channels: "All",
        },
        {
          system: "PRM",
          purpose: "Partner portal, deal registration, MDF",
          channels: "Partners",
        },
        {
          system: "CPQ",
          purpose: "Consistent pricing and quoting",
          channels: "All",
        },
        {
          system: "E-commerce",
          purpose: "Self-service transactions",
          channels: "Online, Marketplace",
        },
        {
          system: "Marketing Automation",
          purpose: "Lead routing and nurture",
          channels: "All",
        },
        {
          system: "Analytics",
          purpose: "Cross-channel reporting",
          channels: "All",
        },
      ],
      dataRequirements: [
      ...
      <div className="max-w-6xl">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-2xl text-slate-600">
                Multi-Channel Revenue & Distribution
              </p>
            </div>
          </div>
          <div className="bg-indigo-50 border-2 border-indigo-200 rounded-2xl p-6">
            <p className="text-lg text-indigo-900 mb-2">
              <strong>Purpose:</strong> Orchestrate multiple go-to-market
              channels with unified pricing, conflict resolution, and
                ...
                <div className="bg-red-50 p-6 rounded-2xl border-2 border-red-200">
                  ...
                  <ul className="space-y-3 text-slate-700">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Price wars between channels destroy margins</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-600 font-bold">•</span>
                      <span>Channel conflicts lose deals and partners</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-600 font-bold">•</span>
                      <span>No visibility into channel performance</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-600 font-bold">•</span>
                      <span>
                        Customers frustrated by inconsistent experience
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-600 font-bold">•</span>
                      <span>Suboptimal channel mix limits growth</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-green-50 p-6 rounded-2xl border-2 border-green-200">
                  ...
                  <ul className="space-y-3 text-slate-700">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Automated pricing controls protect margins</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-600 font-bold">✓</span>
                      <span>Clear conflict resolution preserves deals</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-600 font-bold">✓</span>
                      <span>Real-time analytics optimize channel mix</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-600 font-bold">✓</span>
                      <span>Omnichannel experience delights customers</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-600 font-bold">✓</span>
                      <span>Data-driven investment maximizes ROI</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                {[
                  ...
                  },
                  {
                    type: "Digital",
                    icon: Monitor,
                    channels: ["E-Commerce", "Marketplace", "Self-Service"],
                      ...
                      <div className="bg-red-50 p-6 rounded-2xl border-2 border-red-200">
                        ...
                        <div className="space-y-3 text-sm">
                          <p>
                            ...
                            {scenario.withoutAnalytics.what}
                          </p>
                          <p>
                            <strong>Result:</strong>{" "}
                            {scenario.withoutAnalytics.result}
                          </p>
                          <p className="font-bold text-red-800 text-lg pt-3 border-t border-red-200">
                            Impact: {scenario.withoutAnalytics.loss}
                          </p>
                        </div>
                      </div>
                      <div className="bg-green-50 p-6 rounded-2xl border-2 border-green-200">
                        ...
                        <div className="space-y-3 text-sm">
                          <p>
                            <strong>What Happens:</strong>{" "}
                            {scenario.withAnalytics.what}
                          </p>
                          <p>
                            <strong>Action:</strong>{" "}
                            {scenario.withAnalytics.action}
                          </p>
                          <p>
                            <strong>Result:</strong>{" "}
                            {scenario.withAnalytics.result}
                          </p>
                          <p className="font-bold text-green-800 text-lg pt-3 border-t border-green-200">
                            Saved: {scenario.withAnalytics.saved}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        {scenario.evolution.map((stage, i) => (
                          <div
                            key={`item-${i}`}
                            className="bg-gradient-to-r from-indigo-50 to-white p-4 rounded-xl border border-indigo-200"
                          >
                            <div className="grid grid-cols-5 gap-4 text-sm">
                              <div>
                                <span className="font-bold">{stage.year}</span>
                              </div>
                              <div>
                              ...
                              <div>
                                <span>{stage.margin} margin</span>
                              </div>
                              <div>
                                <span>{stage.customers} customers</span>
                              </div>
                            </div>
                          </div>
                        ))}
          ...
          <div className="space-y-8">
            <div className="bg-gradient-to-r from-indigo-600 to-indigo-800 p-8 rounded-3xl text-white">
              ...
              <p className="text-xl opacity-90">
                Based on Forrester, Gartner, and leading go-to-market strategies
              </p>
            </div>
        ...
        {activeTab === "data" && (
          <div className="space-y-8">
            <div className="bg-gradient-to-r from-indigo-600 to-indigo-800 p-8 rounded-3xl text-white">
              ...
              <p className="text-xl opacity-90">
                Example data across all go-to-market channels
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-4">
              ...
              <div className="bg-white p-6 rounded-xl border border-slate-200">
                ...
                <p className="text-3xl font-bold text-[#033F99]">6,200</p>
              </div>
              <div className="bg-white p-6 rounded-xl border border-slate-200">
        ...
        <div className="mt-16 bg-gradient-to-r from-indigo-600 to-indigo-800 rounded-3xl p-8 text-white text-center">
          ...
          <p className="text-xl mb-6 opacity-90">
            See how IB Commerce helps you orchestrate multiple channels for
