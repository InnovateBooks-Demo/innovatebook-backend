  ...
  const profileManagementFeatures = [
    {
      ...
      description:
        "Pre-defined credit terms and limits based on customer segment, risk level, and relationship history.",
      profileTypes: [
        {
          profile: "Enterprise Premium",
          creditLimit: "$5,000,000",
          paymentTerms: "Net 60",
          earlyPayDiscount: "2% Net 10",
          riskTolerance: "Low",
        },
        {
      ...
      prevention:
        "Prevents bad debt while enabling good customers to grow their business with you",
    },
    {
      feature: "Pricing Profiles",
      description:
        "Standardized pricing tiers and discount structures based on customer value and relationship.",
      profileTypes: [
        {
          profile: "Strategic Account",
          baseDiscount: "25%",
          volumeDiscount: "Up to 15% additional",
          specialPricing: "Custom negotiated",
          approval: "Pre-approved",
        },
        {
          profile: "Premier Customer",
          baseDiscount: "20%",
          volumeDiscount: "Up to 10% additional",
          specialPricing: "Request basis",
          approval: "Manager",
        },
        {
          profile: "Standard Customer",
          baseDiscount: "10%",
          volumeDiscount: "Up to 5% additional",
          specialPricing: "None",
          approval: "Auto",
        },
        {
        ...
        {
          profile: "Government/EDU",
          baseDiscount: "30%",
          volumeDiscount: "Up to 10% additional",
          specialPricing: "GSA Schedule",
          approval: "Pre-approved",
        },
      ],
      rules: [
      ...
      prevention:
        "Prevents margin erosion from inconsistent pricing while rewarding valuable customers",
    },
    {
      feature: "Service Level Profiles",
      description:
        "Tiered service levels defining support, delivery, and engagement expectations.",
      profileTypes: [
        {
          ...
          escalation: "Direct to VP",
          reviews: "Weekly",
        },
        {
          profile: "Gold Service",
          responseTime: "4 hours",
          accountManager: "Named",
          supportHours: "24/7",
          escalation: "Manager",
          reviews: "Bi-weekly",
        },
        {
          profile: "Silver Service",
          responseTime: "8 hours",
          accountManager: "Pooled",
          supportHours: "Business hours",
          escalation: "Standard",
          reviews: "Monthly",
        },
        {
          profile: "Bronze Service",
        ...
        },
        {
          ...
          accountManager: "None",
          supportHours: "Self-serve portal",
          escalation: "Ticket",
          reviews: "None",
        },
      ],
      ...
      prevention:
        "Prevents service level mismatches and ensures resources aligned with customer value",
    },
    {
      feature: "Commercial Terms Profiles",
      description:
        "Standardized contract terms and conditions based on deal type, customer segment, and risk.",
      termCategories: [
        {
          category: "Liability",
          standard: "Capped at contract value",
          enterprise: "Negotiable up to 2x",
          government: "Per regulation",
        },
        {
          category: "Warranty",
          standard: "1 year",
          enterprise: "Up to 3 years",
          government: "Per specification",
        },
        {
          category: "SLA Penalties",
          standard: "Service credits only",
          enterprise: "Up to 20% monthly fee",
        ...
        },
        {
          ...
          government: "Per requirement",
        },
      ],
      profileApplication: [
        {
          profile: "Standard Terms",
          applicability: "SMB, standard products",
          deviation: "None allowed",
        },
        {
          profile: "Enterprise Terms",
          applicability: "Enterprise customers, complex deals",
          deviation: "Legal approval required",
        },
        {
          profile: "Government Terms",
          applicability: "Public sector",
          deviation: "Pre-approved templates",
        },
        {
          profile: "Partner Terms",
          applicability: "Channel partners",
          deviation: "Partner agreement governs",
        },
      ],
      example: {
        ...
        negotiation:
          "Legal approved 3x cap with specific carve-outs, escrow with release triggers",
        outcome: "Deal closed with balanced risk allocation",
        timeToClose: "3 days legal review vs 3 weeks without profiles",
      },
      prevention:
        "Prevents legal bottlenecks and ensures consistent risk management across deals",
    },
    {
      feature: "Segmentation Profiles",
      description:
        "Customer categorization for targeted engagement, pricing, and service delivery.",
      dimensions: [
        {
          dimension: "Revenue Tier",
          segments:
            "Enterprise ($1M+), Mid-Market ($100K-$1M), SMB ($10K-$100K), Micro (<$10K)",
        },
        {
          dimension: "Industry",
          segments:
        ...
        },
        {
          ...
          segments: "Prospect, New Customer, Growing, Mature, At-Risk, Churned",
        },
        {
          dimension: "Strategic Value",
          segments: "Flagship, Strategic, Core, Transactional",
        },
      ],
      profileMatrix: [
        {
          combination: "Enterprise + Financial Services + Strategic",
          profile: "White Glove",
          pricing: "Custom",
          service: "Platinum",
          credit: "Enterprise Premium",
        },
        {
          combination: "Mid-Market + Technology + Growing",
          profile: "High Touch",
          pricing: "Premier",
          service: "Gold",
          credit: "Mid-Market",
        ...
        {
          combination: "SMB + Any + New",
          profile: "Digital First",
          pricing: "Standard",
          service: "Silver",
          credit: "New Customer",
        },
        {
          combination: "Micro + Any + Any",
          profile: "Self-Service",
          pricing: "List",
      ...
      example: {
        ...
        benefit:
          "Customer receives appropriate engagement without manual intervention",
      },
      prevention:
        "Prevents one-size-fits-all approach and ensures optimal resource allocation",
    },
  ];
  ...
  const realWorldScenarios = [
    {
      ...
      situation:
        "Rapid growth creating credit risk exposure without clear policies.",
      withoutProfiles: {
      ...
      withProfiles: {
        ...
        action:
          "All customers mapped to appropriate profile based on segment + credit score",
        result: "Consistent credit decisions, proactive monitoring",
        saved: "Bad debt reduced by 85%, from $600K to $90K annually",
      },
      lesson:
        "Standardized credit profiles reduce risk while enabling sales growth.",
    },
    {
      ...
      lesson:
        "Pricing profiles increase margins, reduce sales cycles, and improve customer trust.",
    },
    {
      title: "The Service Level Alignment Story",
      company: "Managed Services Provider",
      situation:
        "All customers receiving same service level regardless of contract value.",
      problem: {
      ...
      solution: {
        action:
          "Implemented tiered service profiles aligned with customer value",
      ...
      lesson:
        "Service profiles align resources with customer value, improving satisfaction and efficiency.",
    },
    {
      ...
      challenge: [
        {
          issue: "Customers stuck in original segment",
          impact: "Growing customers treated as small",
        },
        {
          issue: "Manual segment reviews",
          impact: "Updates months behind reality",
        },
        {
          issue: "One engagement model",
          impact: "Missed upsell opportunities",
        },
      ],
      solution: [
        {
          change: "Real-time segment recalculation",
          result: "Customers move segments within 24 hours of qualifying",
        },
        {
          change: "Automatic profile updates",
          result: "Pricing, credit, service adjust automatically",
        },
        {
          change: "Triggered engagement",
          result: "Account manager assigned when customer hits threshold",
        },
      ],
      results: {
      ...
      lesson:
        "Dynamic segmentation captures growth opportunities and improves customer experience.",
    },
  ];
  ...
  const bestPractices = [
      ...
      principles: [
        {
          ...
          guideline:
            "Limit to 5-7 profiles per category - too many creates confusion",
        },
        {
          principle: "Clear Criteria",
          guideline: "Objective, measurable criteria for profile assignment",
        },
        {
          principle: "Meaningful Differentiation",
          guideline:
            "Profiles must have meaningful differences that matter to customers and operations",
        },
        {
          principle: "Business Alignment",
          guideline:
            "Profiles should reflect business strategy and customer value",
        },
        {
          principle: "Flexibility",
          guideline: "Allow exceptions with proper approval workflow",
        },
        {
          principle: "Regular Review",
          guideline:
            "Review and adjust profiles quarterly based on business changes",
        },
      ],
    },
    {
      ...
      process: [
        {
          ...
          description: "Gather firmographic, financial, and behavioral data",
        },
        {
          step: "Scoring",
          description: "Apply scoring model to determine segment and value",
        },
        {
          step: "Profile Mapping",
          description: "Map segment + value to appropriate profiles",
        },
        {
          step: "Validation",
          description: "Review high-value assignments manually",
        },
        {
          step: "Communication",
          description:
            "Inform customer-facing teams of profile and implications",
        },
        {
          step: "Monitoring",
          description: "Track profile performance and trigger re-evaluation",
        },
      ],
      automation: [
    ...
    },
    {
      ...
      governanceModel: [
        {
          role: "Profile Owner",
          responsibility: "Define profile criteria and thresholds",
          review: "Quarterly",
        },
        {
          role: "Data Steward",
          responsibility: "Ensure data quality for profile assignment",
          review: "Monthly",
        },
        {
          role: "Business Analyst",
          responsibility: "Monitor profile performance and recommend changes",
          review: "Monthly",
        },
        {
          role: "Executive Sponsor",
          responsibility: "Approve profile changes and resolve disputes",
          review: "Quarterly",
        },
      ],
      metrics: [
        {
          metric: "Profile Distribution",
          target: "Balanced distribution across profiles",
        },
        {
          metric: "Assignment Accuracy",
          target: ">95% correct initial assignment",
        },
        {
          metric: "Exception Rate",
          target: "<10% of transactions require exception",
        },
        { metric: "Profile Churn", target: "<5% profile changes per quarter" },
        {
          metric: "Business Impact",
          target: "Measurable improvement in target metrics",
        },
      ],
    },
    {
      ...
      <div className="max-w-6xl">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-2xl text-slate-600">
                Commercial Terms & Segmentation
              </p>
            </div>
          </div>
          <div className="bg-amber-50 border-2 border-amber-200 rounded-2xl p-6">
            <p className="text-lg text-amber-900 mb-2">
              <strong>Purpose:</strong> Standardize commercial terms, pricing,
              credit, and service levels through reusable profiles that ensure
              consistency and enable automation.
            </p>
          ...
          <div className="space-y-12">
            <section>
              <h2 className="text-3xl font-bold text-slate-900 mb-6">
                Why Commercial Profiles Matter?
              </h2>
                ...
                <div className="bg-red-50 p-6 rounded-2xl border-2 border-red-200">
                  ...
                  <ul className="space-y-3 text-slate-700">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Inconsistent pricing erodes margins</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-600 font-bold">•</span>
                      <span>Ad-hoc credit decisions increase risk</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-600 font-bold">•</span>
                      <span>Service levels misaligned with value</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-600 font-bold">•</span>
                      <span>Every deal negotiated from scratch</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-600 font-bold">•</span>
                      <span>Customer experience varies wildly</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-green-50 p-6 rounded-2xl border-2 border-green-200">
                  ...
                  <ul className="space-y-3 text-slate-700">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Standardized pricing protects margins</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-600 font-bold">✓</span>
                      <span>Credit profiles reduce bad debt 85%</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-600 font-bold">✓</span>
                      <span>Service aligned with customer value</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-600 font-bold">✓</span>
                      <span>Automatic profile assignment saves time</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-600 font-bold">✓</span>
                      <span>Consistent, predictable experience</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <section>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                {[
                  {
                    type: "Credit Profiles",
                    icon: CreditCard,
                    items: ["Credit limits", "Payment terms", "Risk tolerance"],
                    color: "from-blue-600 to-blue-800",
                  },
                  {
                    type: "Pricing Profiles",
                    icon: Percent,
                    items: ["Base discounts", "Volume tiers", "Approval rules"],
                    color: "from-green-600 to-green-800",
                  },
                  {
                    type: "Service Profiles",
                    icon: Star,
                    items: ["SLA levels", "Support access", "Account coverage"],
                    color: "from-purple-600 to-purple-800",
                  },
                  {
                    type: "Terms Profiles",
                    icon: FileText,
                    items: ["Contract terms", "Liability caps", "Warranties"],
                    color: "from-amber-600 to-amber-800",
                  },
                  {
                    type: "Segment Profiles",
                    icon: Users,
                    items: ["Customer tiers", "Industry rules", "Geo settings"],
                    color: "from-indigo-600 to-indigo-800",
                  },
                  {
                    type: "Combined Profiles",
                    icon: Layers,
                    items: [
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full text-sm">
                          <thead className="bg-slate-50">
                            <tr>
                              {Object.keys(feature.profileTypes[0]).map(
                                (key) => (
                                  <th
                                    key={key}
                            ...
                            {feature.profileTypes.map((profile, i) => (
                              <tr key={`item-${i}`}>
                                {Object.values(profile).map((value, j) => (
                                  <td
                                    key={j}
                                    className={`p-3 ${j === 0 ? "font-semibold" : ""}`}
                                  >
                                    {String(value)}
                                  </td>
                                ))}
              ...
              >
                ...
                <div className="p-8 space-y-6">
                      ...
                      <div className="bg-red-50 p-6 rounded-2xl border-2 border-red-200">
                        ...
                        <div className="space-y-3 text-sm">
                          <p>
                            ...
                            {scenario.withoutProfiles.what}
                          </p>
                          <p>
                            <strong>Result:</strong>{" "}
                            {scenario.withoutProfiles.result}
                          </p>
                          <p className="font-bold text-red-800 text-lg pt-3 border-t border-red-200">
                            Loss: {scenario.withoutProfiles.loss}
                          </p>
                        </div>
                      </div>
                      <div className="bg-green-50 p-6 rounded-2xl border-2 border-green-200">
                        ...
                        <div className="space-y-3 text-sm">
                          <p>
                            <strong>What Happens:</strong>{" "}
                            {scenario.withProfiles.what}
                          </p>
                          <p>
                            <strong>Action:</strong>{" "}
                            {scenario.withProfiles.action}
                          </p>
                          <p>
                            <strong>Result:</strong>{" "}
                            {scenario.withProfiles.result}
                          </p>
                          <p className="font-bold text-green-800 text-lg pt-3 border-t border-green-200">
                            Saved: {scenario.withProfiles.saved}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  {scenario.improvement && (
                    <div className="grid md:grid-cols-3 gap-4">
                      {Object.entries(scenario.improvement).map(
                        ([key, value], i) => (
                          <div
                            key={`item-${i}`}
          ...
          <div className="space-y-8">
            <div className="bg-gradient-to-r from-amber-600 to-amber-800 p-8 rounded-3xl text-white">
              ...
              <p className="text-xl opacity-90">
                Guidelines for effective commercial profile implementation
              </p>
            </div>
        ...
        {activeTab === "data" && (
          <div className="space-y-8">
            <div className="bg-gradient-to-r from-amber-600 to-amber-800 p-8 rounded-3xl text-white">
              <h2 className="text-3xl font-bold mb-4">
                Active Commercial Profiles
              </h2>
              <p className="text-xl opacity-90">
                Example profile configuration and customer distribution
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-4">
              <div className="bg-white p-6 rounded-xl border border-slate-200">
                ...
                <p className="text-3xl font-bold text-slate-900">
                  {exampleProfiles.length}
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl border border-slate-200">
                <p className="text-sm text-slate-600 mb-1">Total Customers</p>
                <p className="text-3xl font-bold text-[#033F99]">1,182</p>
              </div>
              <div className="bg-white p-6 rounded-xl border border-slate-200">
        ...
        <div className="mt-16 bg-gradient-to-r from-amber-600 to-amber-800 rounded-3xl p-8 text-white text-center">
          <h2 className="text-3xl font-bold mb-4">
            Ready to Standardize Your Commercial Terms?
          </h2>
          <p className="text-xl mb-6 opacity-90">
            See how IB Commerce profiles reduce risk, protect margins, and
