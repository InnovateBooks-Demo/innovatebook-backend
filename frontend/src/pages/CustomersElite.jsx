    ...
    <div className="min-h-screen bg-gradient-to-br from-[#C4D9F4] via-white to-[#C4D9F4]/50 p-8">
      <div className="mb-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            onClick={() => navigate("/finance/customers/create")}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredCustomers.map((customer) => (
          <div
            key={customer.id}
            className="bg-white/70 backdrop-blur-xl rounded-3xl p-6 border-2 border-[#033F99]/50 shadow-xl hover:shadow-2xl hover:border-[#033F99] transition-all cursor-pointer"
            onClick={() => navigate(`/finance/customers/${customer.id}`)}
          >
            <div className="flex items-start justify-between mb-4">
              ...
              <div className="flex gap-2">
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    navigate(`/finance/customers/${customer.id}/edit`);
                  }}
            ...
            <div className="space-y-2">
              {customer.email && (
                <div className="flex items-center gap-2 text-sm text-[#033F99]/70">
            ...
            <div className="mt-4 pt-4 border-t border-[#033F99]/20">
              <div className="flex justify-between items-center">
                <span className="text-xs text-[#033F99]/70">Outstanding</span>
