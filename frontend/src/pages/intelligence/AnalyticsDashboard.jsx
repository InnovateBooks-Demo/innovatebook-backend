  ...
  const tabs = [
    {
      id: "dashboard",
      label: "Dashboard",
      path: "/intelligence/analytics/dashboard",
    },
    {
      id: "revenue",
      label: "Revenue Analytics",
      path: "/intelligence/analytics/revenue",
    },
    {
      id: "procurement",
      label: "Procurement Analytics",
      path: "/intelligence/analytics/procurement",
    },
    {
      id: "parties",
      label: "Party Analytics",
      path: "/intelligence/analytics/parties",
    },
  ];
        ...
        <div className="px-8 py-6">
          ...
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 bg-blue-100 rounded-xl flex items-center justify-center">
              <BarChart3 className="h-7 w-7 text-[#033F99]" />
            </div>
            <div>
          ...
          {getMetrics().map((metric, i) => (
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <span
                  className={`flex items-center gap-1 text-sm font-medium ${metric.up ? "text-green-600" : "text-red-600"}`}
                >
                  {metric.up ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              {chartData.map((d, i) => (
                ...
                >
                  <div className="w-full flex gap-1 items-end justify-center h-48">
                    <div
                      className="w-5 bg-[rgba(3,63,153,0.08)]0 rounded-t"
                      style={{ height: `${d.revenue * 4}px` }}
                    ></div>
                    <div
                      className="w-5 bg-purple-500 rounded-t"
                      style={{ height: `${d.procurement * 4}px` }}
                    ></div>
                  </div>
            ...
            <div className="flex items-center justify-center gap-6 mt-4">
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-[rgba(3,63,153,0.08)]0 rounded"></div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="flex items-center justify-center gap-4 mt-4">
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-[rgba(3,63,153,0.08)]0 rounded"></div>
                <span className="text-sm text-gray-600">Revenue 50%</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-purple-500 rounded"></div>
                <span className="text-sm text-gray-600">Spend 30%</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-green-500 rounded"></div>
                <span className="text-sm text-gray-600">Profit 20%</span>
              </div>
            </div>
          </div>
        </div>
