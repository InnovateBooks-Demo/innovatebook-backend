...
const InvoicesElite = () => {
  ...
  const loadInvoices = async () => {
    try {
      ...
      const response = await axios.get(`${BACKEND_URL}/api/finance/invoices`, {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#C4D9F4] via-white to-[#C4D9F4]/50 p-8">
      ...
      <div className="bg-white/70 backdrop-blur-xl rounded-3xl p-8 border-2 border-[#033F99]/50 shadow-2xl">
        <h2 className="text-2xl font-bold text-[#033F99] mb-6">Invoice List</h2>
              ...
              {filteredInvoices.map((invoice) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-sm">
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-bold ${invoice.status === "Paid"
