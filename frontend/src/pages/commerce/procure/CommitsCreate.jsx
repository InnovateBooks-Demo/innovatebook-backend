...
const ProcureCommitsCreate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if ((await res.json()).success) navigate("/commerce/procure/commit");
    setLoading(false);
  };

  return (
    <div className="p-6 max-w-4xl mx-auto" data-testid="procure-commits-create">
      <div className="mb-6">
        <Link
        ...
        <h1 className="text-2xl font-bold">New Vendor Commitment</h1>
      </div>
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="bg-white rounded-xl border p-6">
          <h2 className="text-lg font-semibold mb-4 flex items-center gap-2">
            <FileCheck className="w-5 h-5 text-[#033F99]" /> Commitment Details
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                placeholder="Annual Vendor Agreement"
              />
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-4 py-2.5 border rounded-xl"
                placeholder="Annual commitment with volume discount..."
              />
            </div>
          </div>
        </div>
        <div className="flex justify-end gap-3">
          <button
            type="button"
            onClick={() => navigate("/commerce/procure/commit")}
...
export default ProcureCommitsCreate;
