...
const ProcureEvaluationsDetail = () => {
  ...
  const fetchEvaluation = async () => {
    try {
      ...
      const res = await fetch(
        `${API_URL}/api/commerce/modules/procurement/evaluations/${evaluation_id}`,
  ...
  const handleDelete = async () => {
    ...
    navigate("/commerce/procure/evaluate");
  };
  ...
  if (!evaluation)
    return (
      <div className="p-6 text-center">
        <p>Not found</p>
        <Link to="/commerce/procure/evaluate" className="text-[#033F99]">
          Back
        </Link>
      </div>
    );
  ...
  return (
    <div className="p-6" data-testid="procure-evaluations-detail">
      <div className="mb-6">
        <Link
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                {evaluation.evaluation_id || evaluation.eval_id}
              </p>
            </div>
          </div>
          <div className="flex gap-3">
            <button
              onClick={() =>
                navigate(`/commerce/procure/evaluate/${evaluation_id}/edit`)
              }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white rounded-xl border p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <p className="font-semibold">{evaluation.vendor_id || "-"}</p>
            </div>
            <div>
              <p className="text-sm text-gray-500">PR Reference</p>
              <p className="font-mono">{evaluation.pr_id || "-"}</p>
            </div>
            <div>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-xl border p-6">
            ...
            <p className="text-5xl font-bold text-[#033F99]">
              {evaluation.score || 0}
          ...
          <div className="bg-white rounded-xl border p-6">
            ...
            <span
              className={`px-3 py-1 rounded-lg text-sm font-semibold capitalize ${statusColors[evaluation.status] || "bg-gray-100"}`}
            >
...
export default ProcureEvaluationsDetail;
