...
const RiskList = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50" data-testid="risk-list">
        ...
        <div className="px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={() => navigate("/commerce/govern/risk/create")}
      ...
      <div className="px-8 py-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-white rounded-xl border border-gray-200 p-5 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              ...
              <div className="h-12 w-12 rounded-lg bg-[rgba(3,63,153,0.08)] flex items-center justify-center">
                <AlertTriangle className="h-6 w-6 text-[#033F99]" />
              </div>
            </div>
          </div>
          <div className="bg-white rounded-xl border border-gray-200 p-5 hover:shadow-md transition-shadow">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-500">Mitigated</p>
                <p className="mt-2 text-3xl font-semibold text-gray-900">
                ...
                filteredRisks.map((item) => {
                  ...
                  return (
                    <tr
                      ...
                      onClick={() =>
                        navigate(`/commerce/govern/risk/${item.risk_id}`)
                      }
                    >
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium ring-1 ring-inset ${severityConfig.color}`}
                        >
                          <span
                            className={`h-1.5 w-1.5 rounded-full ${severityConfig.dot}`}
                          ></span>
                      ...
                      >
                        <div className="flex items-center justify-end gap-1">
                          ...
                          <button
                            onClick={() =>
                              navigate(
                                `/commerce/govern/risk/${item.risk_id}/edit`,
                              )
                            }
                            className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg"
                          >
        ...
        {filteredRisks.length > 0 && (
          <div className="mt-4 flex items-center justify-between">
            <p className="text-sm text-gray-500">
              Showing{" "}
              <span className="font-medium">{filteredRisks.length}</span> risks
            </p>
          </div>
        )}
      </div>
