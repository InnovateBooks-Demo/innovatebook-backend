...
const RevenueContractsList = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50" data-testid="contracts-list">
                ...
                filteredContracts.map((item) => {
                  ...
                  return (
                    <tr
                      ...
                      onClick={() =>
                        navigate(
                          `/commerce/revenue/contracts/${item.contract_id}`,
                        )
                      }
                    >
                      ...
                      >
                        <div className="flex items-center justify-end gap-1">
                          ...
                          <button
                            onClick={() =>
                              navigate(
                                `/commerce/revenue/contracts/${item.contract_id}/edit`,
                              )
                            }
                            className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg"
                          >
