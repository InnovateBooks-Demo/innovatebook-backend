...
const RevenueCommitsList = () => {
  ...
  const totalValue = commits.reduce((sum, c) => sum + (c.value || 0), 0);
  ...
  return (
    <div className="min-h-screen bg-gray-50" data-testid="commits-list">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Manage proposals and quotes for leads
              </p>
            </div>
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={() => navigate("/commerce/revenue/commits/create")}
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-2 text-3xl font-semibold text-gray-900">
                  {commits.filter((c) => c.status === "accepted").length}
                </p>
              </div>
              ...
              {filteredCommits.length === 0 ? (
                <tr>
                  <td colSpan={6} className="px-6 py-16 text-center">
                    ...
                    <button
                      onClick={() =>
                        navigate("/commerce/revenue/commits/create")
                      }
                ...
                filteredCommits.map((item) => {
                  ...
                  return (
                    <tr
                      ...
                      onClick={() =>
                        navigate(`/commerce/revenue/commits/${item.commit_id}`)
                      }
                    >
                      ...
                      >
                        <div className="flex items-center justify-end gap-1">
                          <button
                            onClick={() =>
                              navigate(
                                `/commerce/revenue/commits/${item.commit_id}`,
                              )
                            }
                          ...
                          <button
                            onClick={() =>
                              navigate(
                                `/commerce/revenue/commits/${item.commit_id}/edit`,
                              )
                            }
                            className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg"
                          >
        ...
        {filteredCommits.length > 0 && (
          <div className="mt-4 flex items-center justify-between">
            <p className="text-sm text-gray-500">
              Showing{" "}
              <span className="font-medium">{filteredCommits.length}</span>{" "}
              proposals
            </p>
...
export default RevenueCommitsList;
