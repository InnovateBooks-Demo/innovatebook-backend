                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      <span
                        className={`inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-medium ${statusColor.light} ${statusColor.text}`}
                      >
                      ...
                      {lead.priority && (
                        <span
                          className={`inline-flex items-center px-2 py-1 rounded-md text-xs font-medium ${priorityColor.light} ${priorityColor.text}`}
                        >
                          {lead.priority}
                        </span>
                      )}
                    ...
                    {/* Hover Actions */}
                    <div
                      className={`absolute bottom-4 right-4 flex items-center gap-1 transition-all duration-200 ${
                        isHovered
                  ...
                  return (
                    ...
                    >
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div
                            className={`w-10 h-10 rounded-lg ${statusColor.light} flex items-center justify-center`}
                          >
                            <span
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-medium ${statusColor.light} ${statusColor.text}`}
                        >
                          <Circle className="w-2 h-2" fill="currentColor" />
                          {lead.status}
                        </span>
                      ...
                      <td className="px-6 py-4">
                        {lead.priority && (
                          <span
                            className={`inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium ${priorityColor.light} ${priorityColor.text}`}
                          >
                            {lead.priority}
                          </span>
                        )}
