              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    {lead.priority && (
                      <span
                        className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-md text-xs font-medium border ${priorityColors.bg} ${priorityColors.text} ${priorityColors.border}`}
                      >
                        <div
