...
const RevenueHandoffsList = () => {
  ...
  const fetchHandoffs = async () => {
    try {
      ...
      const res = await fetch(
        `${API_URL}/api/commerce/workflow/revenue/handoffs`,
        {
  ...
  return (
    <div
      ...
      data-testid="revenue-handoffs-list"
    >
      <div className="bg-white border-b border-gray-200">
        <div className="px-8 py-6">
          <div className="flex items-center gap-4 mb-4">
            <button
              onClick={() => navigate("/commerce/revenue-workflow/contracts")}
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                Stage 5 of Revenue Workflow - Handoff to Finance (Bill &
                Collect)
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold text-teal-800">
                Revenue Workflow Complete
              </p>
              <p className="text-sm text-teal-600">
                Completed handoffs are sent to IB Finance for Billing &
                Collection
              </p>
            </div>
          </div>
            ...
            <tbody className="divide-y divide-gray-100">
              {handoffs.length === 0 ? (
                <tr>
                  ...
                  >
                    No handoffs yet. Sign contracts to create handoffs.
                  </td>
                </tr>
              ) : (
                handoffs.map((handoff) => (
                  <tr
                    ...
                    onClick={() =>
                      navigate(
                        `/commerce/revenue-workflow/handoffs/${handoff.handoff_id}`,
                      )
                    }
                  >
...
export default RevenueHandoffsList;
